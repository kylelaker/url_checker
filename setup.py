...
setup(
    name='url_checker',
    version='0.1',
    packages=['venv.lib.python3.6.distutils', 'venv.lib.python3.6.encodings',
              'venv.lib.python3.6.importlib',
              'venv.lib.python3.6.collections',
              'venv.lib.python3.6.site-packages.pip',
              'venv.lib.python3.6.site-packages.pip.req',
              'venv.lib.python3.6.site-packages.pip.vcs',
              'venv.lib.python3.6.site-packages.pip.utils',
              'venv.lib.python3.6.site-packages.pip.compat',
              'venv.lib.python3.6.site-packages.pip.models',
              'venv.lib.python3.6.site-packages.pip._vendor',
              ...
              'venv.lib.python3.6.site-packages.pip.commands',
              'venv.lib.python3.6.site-packages.pip.operations',
              'venv.lib.python3.6.site-packages.idna',
              'venv.lib.python3.6.site-packages.yaml',
              'venv.lib.python3.6.site-packages.wheel',
              'venv.lib.python3.6.site-packages.wheel.tool',
              'venv.lib.python3.6.site-packages.wheel.signatures',
              'venv.lib.python3.6.site-packages.certifi',
              'venv.lib.python3.6.site-packages.chardet',
              'venv.lib.python3.6.site-packages.chardet.cli',
              'venv.lib.python3.6.site-packages.urllib3',
              'venv.lib.python3.6.site-packages.urllib3.util',
              ...
              'venv.lib.python3.6.site-packages.setuptools',
